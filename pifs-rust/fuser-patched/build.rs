    ...
    #[cfg(feature = "libfuse")]
    {
        if cfg!(target_os = "macos") {
                ...
                .is_ok()
            {
                ...
                // Don't set macfuse-4-compat: macFUSE 5.x no longer sends the extra
                // flags/padding fields in fuse_rename_in unless FUSE_CAP_RENAME_SWAP
                // is negotiated, which we don't do.
            } else {
